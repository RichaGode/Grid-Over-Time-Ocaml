...
(*KNIGHT FUNCTIONS *)
  ...
  let get_health_t : L.lltype = 
    L.function_type i32_t [| knight_ptr_t |] in
  let get_health_func : L.llvalue = 
    L.declare_function "get_health" get_health_t the_module in
...
(*     | A.Exp     -> L.pow *)
    ...
    | A.Mod     -> L.build_srem
      ...
      | SCall ("set_stealth", [e1;e2]) -> 
        ...
        "set_stealth" builder
      | SCall ("get_health", [e]) -> 
        L.build_call get_health_func [| (expr builder e)|] 
        "get_health" builder
